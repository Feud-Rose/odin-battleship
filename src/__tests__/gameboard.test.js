...
/*     const createTileArrayStaticXSpy = jest.spyOn(gameBoardTest, "createTileArrayStaticX");
    ...
    test('Row 8 is correct', () => {
        expect(gameBoardTest.grid[8]).toStrictEqual([
            {"status": "null"},{"status": "empty","attacked": false, "fog": false},{"status": "empty","attacked": false, "fog": false},
            {"status": "empty","attacked": false, "fog": false},{"status": "empty","attacked": false, "fog": false},
            {"status": "empty","attacked": false, "fog": false},{"status": "empty","attacked": false, "fog": false},
            {"status": "empty","attacked": false, "fog": false},{"status": "empty","attacked": false, "fog": false},
            {"status": "empty","attacked": false, "fog": false},{"status": "empty","attacked": false, "fog": false},{"status": "null"}]
        )
    })
